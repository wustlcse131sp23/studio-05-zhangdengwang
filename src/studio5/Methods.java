...
public class Methods {
	...
	/**
	 * calculate the mean of the integers in an array
	 * @param array - values in an array of integers;
	 * @return a double of the mean
	 */
	public static double arrayMean(int[] array) {

		double mean = arraySum(array) / ((double) array.length);
		return mean;
